...
export default function Home() {
  ...
  const formatDurationLabel = (mins: string) => {
    if (mins === "60") return "60 Mins (1 Hour)";
    if (mins === "90") return "90 Mins (1.5 Hours)";
    if (mins === "120") return "120 Mins (2 Hours)";
    if (mins === "150") return "150 Mins (2.5 Hours)";
              ...
              <div className="px-5 sm:px-6 py-4 grid grid-cols-2 gap-y-5 gap-x-4 bg-neutral-900/30">
                ...
                <div className="col-span-2">
                  ...
                  <span className="text-xs sm:text-sm font-bold text-lime-400 uppercase tracking-wider">
                    {duration ? formatDurationLabel(duration) : "TBD"}
                  </span>
                </div>
              </div>
            ...
            >
               ...
               <div className="grid grid-cols-2 gap-4 bg-black/50 p-4 border border-neutral-800/50">
                  ...
                  <div>
                     ...
                     <span className="text-sm font-bold text-lime-400 uppercase tracking-wider">{formatDurationLabel(duration)}</span>
                  </div>
               </div>
