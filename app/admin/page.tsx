...
export default function CoachPage() {
  ...
  const [tab, setTab] = useState<"roster" | "bookings" | "blocks">("roster");
              ...
              <form onSubmit={registerNewStudent} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full p-3.5 bg-neutral-950 border border-neutral-800 focus:border-lime-400 outline-none text-sm font-medium transition-colors"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    maxLength={10}
                    className="w-full p-3.5 bg-neutral-950 border border-neutral-800 focus:border-lime-400 outline-none text-sm font-medium font-mono transition-colors"
                  />
                </div>
            ...
            >
              <div className="p-4 sm:p-5 border-b border-neutral-900 flex flex-col sm:flex-row sm:items-center gap-3 justify-between">
                ...
                <input
                  ...
                  className="w-full sm:w-64 p-2.5 bg-neutral-950 border border-neutral-800 focus:border-lime-400 outline-none text-xs font-mono transition-colors"
                />
              </div>
